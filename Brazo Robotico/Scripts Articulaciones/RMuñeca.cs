...
public class RMuñeca : MonoBehaviour
{
    void Update()
    {
        ...
        if(Input.GetKey(KeyCode.D)){  //Si la tecla A se pulsa, targetVelocity tendra un valor de -90
            motor.targetVelocity = -90;
        }
        else{
            if(Input.GetKey(KeyCode.F)){ //Si la tecla D se pulsa, targetVelocity tendra un valor de 90
                motor.targetVelocity = 90;
            }
