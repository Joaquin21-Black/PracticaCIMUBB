...
public class RBrazo : MonoBehaviour
{
    void Update()
    {
        ...
        if(Input.GetKey(KeyCode.E)){  //Si la tecla A se pulsa, targetVelocity tendra un valor de -90
            motor.targetVelocity = -90;
        }
        else{
            if(Input.GetKey(KeyCode.R)){ //Si la tecla D se pulsa, targetVelocity tendra un valor de 90
                motor.targetVelocity = 90;
            }
