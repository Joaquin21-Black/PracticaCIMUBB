...
public class RMano : MonoBehaviour
{
    void Update()
    {
        ...
        if(Input.GetKey(KeyCode.Z)){  //Si la tecla A se pulsa, targetVelocity tendra un valor de -90
            motor.targetVelocity = -90;
        }
        else{
            if(Input.GetKey(KeyCode.X)){ //Si la tecla D se pulsa, targetVelocity tendra un valor de 90
                motor.targetVelocity = 90;
            }
